...
import { Navbar, NavbarBrand ,Jumbotron ,Nav ,NavbarToggler , NavItem , Collapse, Button,Modal , ModalHeader, ModalBody,
...
class Header extends Component {
    ...
    render() {
        return (
            //React Fragment: enables to bunch grp of react elements together
            <React.Fragment>
